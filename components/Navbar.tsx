...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-lg border-b border-amber-100">
        ...
        <div className="max-w-[1600px] mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-black text-gray-900 tracking-tighter italic font-serif">Sacred Almanac</span>
      ...
      <motion.div
        className="absolute bottom-0 left-0 right-0 h-1 bg-amber-600 origin-left"
        style={{ scaleX }}
      />
    </nav>
  );
